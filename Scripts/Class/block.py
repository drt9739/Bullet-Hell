...
class Block:
    ...
    def __init__(self, board, type_block, collision_level,
                 sprite, global_x, global_y):  # Принимает тип клетки, уровень коллизии*, спрайт (открытый файл)
        ...
        self.sprite.rect.x = global_x * cell_size - 12
        self.sprite.rect.y = global_y * cell_size - 46